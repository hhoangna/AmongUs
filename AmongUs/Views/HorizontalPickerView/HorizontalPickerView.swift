...
//  AnniCount-
//
//  Created by HHumorous on 16/10/2020.
//
...
open class AKPickerView: UIView, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout, AKCollectionViewLayoutDelegate {
    ...
    open lazy var font = UIFont(name: "AmaticSC-Bold", size: 24)!

    /// Readwrite. A font which used in selected cells.
    open lazy var highlightedFont = UIFont(name: "AmaticSC-Bold", size: 24)!

    /// Readwrite. A color of the text on NOT selected cells.
    @IBInspectable open lazy var textColor: UIColor = UIColor.white.withAlphaComponent(0.2)

    /// Readwrite. A color of the text on selected cells.
    @IBInspectable open lazy var highlightedTextColor: UIColor = UIColor.white

    /// Readwrite. A float value which indicates the spacing between cells.
    @IBInspectable open var interitemSpacing: CGFloat = 20.0
    ...
    open var maskDisabled: Bool! = nil {
        didSet {
...
//        self.collectionView.collectionViewLayout.invalidateLayout()
        ...
        if self.dataSource != nil && self.dataSource!.numberOfItemsInPickerView(self) > 0 {
            self.selectItem(self.selectedItem, animated: true, notifySelection: false)
        }
    }
